...
def main():
    ...
    parser.add_argument("--image", default="15.jpg", help="Path to a manga/manhwa test image (default: 15.jpg)")
    parser.add_argument("--url", default="http://localhost:8000", help="Server URL for endpoint tests (default: http://localhost:8000)")
